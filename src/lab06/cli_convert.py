...
def main():
    ...
    p1 = sub.add_parser(
        "json2csv", help="конвертация lson to csv"
    )  # Необходимо прописыват ьпосле импорта файла
    p1.add_argument(
        "-i",
        "--input",
        dest="input_file",
    ...
    inf = make_obs(args.output_file)
    ouf = make_obs(args.input_file)
